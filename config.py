...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "8532246333:AAHRl-Ik4zrIEQCy6A8tMLNlGWbMoEMbTUI")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "@youtube87_bot") # Bot username without @.
